var api = "68bbfc241022a172bb84490487549802";
//dark sky api: https://darksky.net/dev
var api_aqi = "24f8e7601f9dd71eda2d8459b2cd5f421600bd17"
//aqi api: http://aqicn.org/data-platform/token/#/
var lang = "zh"
var lat_lon = "23.15089416503906,113.4564666748046"
...
function aqi(icon, daily_mintemp, daily_maxtemp, daily_prec_chance, hour_summary){
    ...
    $task.fetch(aqi).then(response => {
        ...
        loc = loc.split(",")[1];
        $notify(loc, icon + " " + Math.round(daily_mintemp) + " - " + Math.round(daily_maxtemp) + "°  ☔️ " + (Number(daily_prec_chance) * 100).toFixed(1) + "%" + "  😷 " + aqi, hour_summary);
    }, reason => {
